...
/**
 * Selects a reusable atmosphere image for the tavern hero.
...
function resolveSpaceHomeImage(tavern: Tavern, index = 0) {
  return resolveHomepageTavernCover(tavern, index) || homeBlackHeroVisual
}
      ...
      <div className="relative mx-auto w-full max-w-[1320px] px-3 py-4 pb-8 sm:px-5 lg:px-6 lg:py-6 xl:px-7">
        ...
        <div className="min-w-0 space-y-5">
          <div className="grid min-w-0 gap-4 xl:grid-cols-[minmax(0,0.82fr)_minmax(680px,1.18fr)] xl:items-stretch">
            ...
            <section id="tavern-mainline" className="scroll-mt-6 rounded-[1.4rem] border border-cyan-200/16 bg-[#061126]/78 p-3 shadow-[0_30px_86px_rgba(0,0,0,0.30)] sm:p-4 xl:h-[640px] xl:overflow-hidden">
