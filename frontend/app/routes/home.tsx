...
const taverns: TavernPreview[] = [
  { image: tavernNightImage, name: "夜莺酒馆", location: "成都 · 宽窄巷子", distance: "320m", tags: ["人气推荐", "剧情丰富"], id: "tavern-001" },
  { image: tavernNeonImage, name: "雾红驿站", location: "重庆 · 九街", distance: "1.2km", tags: ["赛博风格", "夜生活"], id: "tavern-002" },
  { image: tavernStreetImage, name: "黑猫公社", location: "广州 · 永庆坊", distance: "2.1km", tags: ["社区温度", "NPC 多"], id: "tavern-003" },
]
