...
export const NPC_PERSONALITY_TEMPLATES = [
  ...
  },
  {
    ...
    category: '反面人设',
    badge: '🧊',
    summary: '适合边缘人据点、交易所酒馆、冷面委托人：不兜底情绪，但给有用的东西。',
    bestFor: '赛博夜店 / 交易所 / 冷面委托人 / 边缘人据点',
    ...
    keywords: ['冷淡', '疏离', '边缘', '交易', '利益', '冷静', '冷面', '不兜底', '赛博', '委托人', '冰块'],
    talkativeness: 0.38,
  },
  // ─────────────────────────────────────────────────────────────────────────
  // 古装宫廷
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: '古装宫廷',
    badge: '⚖️',
    summary: '适合宫廷酒馆、皇帝型 NPC：惜字如金，一个字能定生死。',
    bestFor: '宫廷酒馆 / 权谋酒馆 / 冷面主角',
