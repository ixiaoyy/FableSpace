...
import { TAVERN_ACTIVITY_GUARDRAILS, buildTavernActivityEchoes } from "../lib/tavern-activity-echoes.js"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "../ui/card"

type TavernActivityEchoesCardProps = {
  tavern: Tavern
}

export function TavernActivityEchoesCard({ tavern }: TavernActivityEchoesCardProps) {
