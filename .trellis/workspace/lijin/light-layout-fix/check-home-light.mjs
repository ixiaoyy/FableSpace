...
try {
  ...
  const surface = page.locator('[data-soul-link-reference="home-light-real-dom-1536x1024"]')
  ...
  await page.screenshot({ path: resolve(artifactDir, "home-light-after-fix.png"), fullPage: true })
  console.log(`ok ${resolve(artifactDir, "home-light-after-fix.png")}`)
} finally {
  await browser.close()
