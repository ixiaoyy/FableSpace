...
class GraphMemoryStore(MemoryStore):
    ...
    def save_atom(self, space_id: str, atom: MemoryAtom) -> MemoryAtom:
        return self.fallback.save_atom(space_id, atom)

    def delete_atom(self, space_id: str, memory_id: str) -> bool:
        return self.fallback.delete_atom(space_id, memory_id)
    ...
    def related_atoms(
        ...
        *,
        ...
        candidates = self.fallback.list_atoms(space_id, include_flagged=False)
