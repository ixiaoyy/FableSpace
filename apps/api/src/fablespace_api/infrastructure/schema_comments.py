...
TABLE_COMMENTS: dict[str, str] = {
    ...
    "private_memories": "私有记忆表：保存已通过上游筛选且可追溯来源事件的故事记忆。",
}
...
COLUMN_COMMENTS: dict[str, dict[str, str]] = {
    ...
    "story_runs": {
        ...
        "private_memories": "004 垂直切片保留的内联记忆 JSON；新写入使用 private_memories 表。",
    ...
    "story_events": {
        ...
        "event_type": "受控事件类型，如 run_started、message、choice 或 relationship_changed。",
        "character_id": "事件关联 Character ID，可为空。",
        "role": "消息角色：player、character 或 system；非消息可为空。",
        "content": "玩家可观察的事件正文。",
        "source_kind": "事件来源类型，如 authored、free_input、reviewed_choice 或 filtered_memory。",
