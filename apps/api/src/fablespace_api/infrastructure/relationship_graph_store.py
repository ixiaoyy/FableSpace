...
from fablespace_api.core.relationship_graph import RelationshipEdge, RelationshipProjection
from fablespace_api.infrastructure.database import Database
from fablespace_api.infrastructure.models import RelationshipEdgeModel, VisitorRelationshipProjectionModel
...
class SQLAlchemyRelationshipGraphStore:
    ...
    def upsert_projection(self, projection: RelationshipProjection) -> RelationshipProjection:
        ...
        with self.database.session_scope() as session:
            ...
            if model is None:
                ...
                session.add(model)
            model.space_id = projection.space_id or ""
    ...
    def _apply_edge_to_model(model: RelationshipEdgeModel, edge: RelationshipEdge, now: datetime) -> None:
        ...
        model.source_space_id = edge.source_space_id
        ...
        model.target_space_id = edge.target_space_id
