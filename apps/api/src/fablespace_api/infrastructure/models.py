...
class TavernModel(Base):
    ...
    place_type = Column(String(32), nullable=False, default="space")
...
class CharacterModel(Base):
    ...
    id = Column(String(64), primary_key=True)
    space_id = Column(String(64), ForeignKey("taverns.id", ondelete="CASCADE"), primary_key=True)
    name = Column(String(255), nullable=False)
    description = Column(Text, default="")
    ...
    __table_args__ = (Index("idx_char_tavern_id", "space_id"),)
...
class WorldInfoModel(Base):
    ...
    __table_args__ = (Index("idx_wi_tavern_id", "space_id"),)
...
class VisitorModel(Base):
    ...
    id = Column(String(64), primary_key=True)
    space_id = Column(String(64), ForeignKey("taverns.id", ondelete="CASCADE"), nullable=False)
    ...
    __table_args__ = (
        Index("uk_tavern_visitor", "space_id", "visitor_id", unique=True),
...
class ChatMessageModel(Base):
    ...
    __table_args__ = (
        Index("idx_cm_tavern_visitor", "space_id", "visitor_id"),
        Index("idx_cm_tavern_character", "space_id", "character_id"),
...
class MemoryAtomModel(Base):
    ...
    __table_args__ = (
        Index("idx_ma_tavern_id", "space_id"),
...
class GameplaySessionModel(Base):
    ...
    __table_args__ = (
        Index("idx_gs_tavern_visitor", "space_id", "visitor_id"),
...
class NpcPublicBondModel(Base):
    ...
    __table_args__ = (
        Index("idx_npb_tavern_character", "space_id", "character_id", "status"),
...
class TavernMessageModel(Base):
    ...
    __table_args__ = (
        Index("idx_tm_tavern_created", "space_id", "created_at"),
...
class StateCardModel(Base):
    ...
    __table_args__ = (
        Index("idx_sc_tavern_status", "space_id", "status"),
        Index("idx_sc_tavern_visitor", "space_id", "visitor_id"),
...
class RelationshipEdgeModel(Base):
    ...
    source_space_id = Column(String(64), nullable=False, default="")
    ...
    target_space_id = Column(String(64), nullable=False, default="")
...
class VisitorRelationshipProjectionModel(Base):
    ...
    space_id = Column(String(64), nullable=False, default="")
    ...
    __table_args__ = (
        Index("idx_rel_projection_tavern", "space_id"),
...
class VisitorNoteModel(Base):
    ...
    __table_args__ = (
        Index("idx_vn_tavern_created", "space_id", "created_at"),
...
class NeighborhoodRumorModel(Base):
    ...
    id = Column(String(64), primary_key=True)
    source_space_id = Column(String(64), nullable=False)
    target_space_id = Column(String(64), nullable=False)
    ...
    __table_args__ = (
        Index("idx_rumor_source", "source_space_id", "is_active"),
        Index("idx_rumor_target", "target_space_id"),
...
class TerritoryModel(Base):
    ...
    id = Column(String(64), primary_key=True)
    owner_id = Column(String(64), nullable=False)
    space_id = Column(String(64), ForeignKey("taverns.id", ondelete="SET NULL"), nullable=True)
    ...
    __table_args__ = (
        ...
        Index("idx_territory_tavern", "space_id"),
