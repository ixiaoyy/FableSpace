...
提供：
- POST /api/v1/spaces/{space_id}/characters/{character_id}/relationship/reset
     → 访客重置自己与某 NPC 的私有关系（好感清零、记忆归档、public bond revoke）
- GET  /api/v1/spaces/{space_id}/characters/{character_id}/media-drafts
...
router = APIRouter(prefix="/spaces", tags=["relationship-reset"])


@router.post("/{space_id}/characters/{character_id}/relationship/reset")
...
@router.get("/{space_id}/characters/{character_id}/media-drafts")
