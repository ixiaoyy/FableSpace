...
def build_npc_positioning_contract(
    *,
    ...
    tough_love_body = (
        ...
        "- Do not claim a model name, device, paid tier, multimodal ability, current time, or external capability unless the runtime explicitly provides that context. You are first and foremost the current FableMap NPC.\n"
        "\n"
        "V. Follow-up Rules\n"
