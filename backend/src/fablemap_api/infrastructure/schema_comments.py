"""Authoritative SQLAlchemy table and column comments for FableMap.
...
TABLE_COMMENTS: dict[str, str] = {
    "taverns": "FableMap 空间主表：真实坐标锚定的可进入空间及店主配置。",
...
COLUMN_COMMENTS: dict[str, dict[str, str]] = {
    ...
    "notifications": {
        ...
        "created_at": "通知创建时间。",
        "read": "是否已读。",
        "tavern_id": "关联空间 ID，可为空。",
        "tavern_name": "关联空间名称快照。",
    },
    "neighborhood_rumors": {
        "id": "传闻唯一 ID。",
        "source_tavern_id": "传闻来源空间 ID。",
        "target_tavern_id": "传闻指向的目标空间 ID。",
