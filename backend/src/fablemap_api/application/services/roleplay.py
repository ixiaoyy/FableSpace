...
class RoleplayApplicationMixin:
    ...
    def get_roleplay(self, tavern_id: str, user_id: str = "") -> dict[str, Any]:
    ...
    def save_roleplay_config(self, tavern_id: str, data: dict[str, Any], user_id: str = "") -> dict[str, Any]:
        tavern = self._get_tavern_or_404(tavern_id)
        ...
        return {"ok": True, **self.get_roleplay(tavern_id, user_id)}

    def request_character_claim(self, tavern_id: str, data: dict[str, Any], user_id: str = "") -> dict[str, Any]:
        tavern = self._get_tavern_or_404(tavern_id)
        self._ensure_visible(tavern, user_id)
        ...
        for claim in tavern.character_claims:
            if (
                ...
                return {"ok": True, "claim": claim, **self.get_roleplay(tavern_id, player_id)}
    ...
    def decide_character_claim(
        ...
        self.store.update_tavern(tavern)
        return {"ok": True, "claim": claim, **self.get_roleplay(tavern_id, user_id)}
