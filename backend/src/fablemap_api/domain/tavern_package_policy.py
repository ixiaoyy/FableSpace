...
def package_list(package: dict[str, Any], tavern_payload: dict[str, Any], key: str) -> list[Any]:
...
def package_dict(package: dict[str, Any], tavern_payload: dict[str, Any], key: str) -> dict[str, Any]:
    value = package.get(key)
