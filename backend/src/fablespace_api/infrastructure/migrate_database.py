...
from fablespace_api.infrastructure.env import parse_env_file
...
def main() -> None:
    ...
    parser.add_argument("--target-url", default="", help="Target SQLAlchemy URL. Defaults to .env FABLESPACE_DATABASE_URL")
    parser.add_argument("--env-file", default=".env", help="Env file used to resolve FABLESPACE_DATABASE_URL")
