...
from fablespace_api.core.home import Home, HomeMember, HomeVisit, HomeStatus, HomeVisitSettings, HomeMemberType, get_nonliving_response
...
class HomeStore:
    ...
    def __init__(self, data_root: str = ".fablespace-api/homes"):
...
class SQLAlchemyHomeStore(HomeStore):
    ...
    def create_home(self, owner_id: str, name: str, description: str = "", avatar: str = "", cover_image: str = "", theme: str = "cozy", visit_settings: dict[str, Any] | None = None, members: list[dict[str, Any]] | None = None) -> Home:
        from fablespace_api.infrastructure.models import HomeModel
    ...
    def delete_home(self, home_id: str) -> bool:
        from fablespace_api.infrastructure.models import HomeModel, HomeVisitModel
    ...
    def get_visits(self, home_id: str, limit: int = 50) -> list[HomeVisit]:
        from fablespace_api.infrastructure.models import HomeVisitModel
