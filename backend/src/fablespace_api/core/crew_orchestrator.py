...
DEFAULT_ROLES = [
    AgentRole(
        ...
        allowed_paths=["docs/", "backend/src/fablespace_api/core/", "tests/", "frontend/app/"],
        deliverables=[
    ...
    AgentRole(
        ...
        allowed_paths=["backend/src/fablespace_api/core/", "frontend/app/", "scripts/", "tests/"],
        deliverables=[
            "Code changes",
    ...
    AgentRole(
        ...
        allowed_paths=["tests/", "backend/src/fablespace_api/core/", "frontend/app/"],
        deliverables=[
